...
DMULTIMEDIA_BEGIN_NAMESPACE
    ...
    void DMpvGLWidget::onFrameSwapped()
    {
        //qInfo() << "frame swapped";
    ...
    DMpvGLWidget::DMpvGLWidget(QWidget *parent, MpvHandle h)
        ...
        connect(this, &QOpenGLWidget::frameSwapped, 
                this, &DMpvGLWidget::onFrameSwapped, Qt::DirectConnection);
    }

    DMpvGLWidget::~DMpvGLWidget() 
    {
        makeCurrent();
        if (m_pDarkTex) {
            m_pDarkTex->destroy();
    ...
    void DMpvGLWidget::setupBlendPipe()
    {
        updateMovieFbo();
    ...
    void DMpvGLWidget::setupIdlePipe()
    {
        m_vao.create();
        m_vao.bind();
    ...
    void DMpvGLWidget::prepareSplashImages()
    {
        QPixmap pixmap;
    ...
    //cppcheck误报
    void DMpvGLWidget::initializeGL()
    {
    ...
    void DMpvGLWidget::updateMovieFbo()
    {
    ...
    void DMpvGLWidget::updateCornerMasks()
    {
    ...
    void DMpvGLWidget::updateVboBlend()
    {
    ...
    void DMpvGLWidget::updateVboCorners()
    {
        auto vp = rect().size();
    ...
    void DMpvGLWidget::resizeGL(int nWidth, int nHeight)
    {
    ...
    void DMpvGLWidget::toggleRoundedClip(bool bFalse)
    {
    ...
    /*not used yet*/
    /*void DMpvGLWidget::setHandle(myHandle h)
    {
        m_handle = h;
    }*/

    void DMpvGLWidget::paintGL() 
    {
        QOpenGLFunctions *pGLFunction = QOpenGLContext::currentContext()->functions();
        if (m_bPlaying) {
...
//                    }
...
#ifdef __x86_64__
    void DMpvGLWidget::updateMovieProgress(qint64 duration, qint64 pos)
    {
        if (pos > duration)
            pos = duration;
    ...
    void DMpvGLWidget::setRawFormatFlag(bool bRawFormat)
    {
        m_bRawFormat = bRawFormat;
    }

    void DMpvGLWidget::setPlaying(bool bFalse)
    {
